...
def bill():
    ...
    if C_Name.get() == "" or P_number.get() == "":
        ...
        Total_Price = [Total1.get(), Total2.get(), Total3.get(), Total4.get(), Total5.get(), Total6.get(), Total7.get(),
                       Total8.get(), Total9.get(), Total10.get(), Total11.get(), Total12.get(), Total13.get(),
                       Total14.get(),
...
def reset():
    ...
    Entry(root, validate="key", validatecommand=valid_num, font=("None 20 bold"), bg="Khaki1", width=8).place(x=1210,
                                                                                                              y=150)
...
P_number = StringVar()
Entry(root, textvariable=P_number, validate="key", validatecommand=valid_num, font=("None 20 bold"), bg="Khaki1").place(
    x=760, y=150)
...
Bill = StringVar()
Bill.set(random.randint(1000, 4999))
Entry(root, textvariable=Bill, validate="key", validatecommand=valid_num, font=("None 20 bold"), bg="Khaki1",
      width=8).place(x=1210, y=150)
...
Button(root, text="Total", font=("None 16 bold"), command=total, bg="olivedrab1", activebackground="olivedrab1", bd=3,
       width=5).place(x=1260, y=285)
Button(root, text="Get Bill", font=("None 16 bold"), command=bill, bg="steelblue2", activebackground="steelblue2", bd=3,
       width=6).place(x=1252, y=365)
Button(root, text="Save", font=("None 16 bold"), command=save, bg="yellow2", activebackground="yellow2", bd=3,
       width=5).place(x=1260, y=445)
Button(root, text="Clear", font=("None 16 bold"), command=reset, bg="salmon", activebackground="salmon", bd=3,
       width=5).place(x=1260, y=525)
Button(root, text="Exit", font=("None 16 bold"), command=exit, bg="skyblue", activebackground="skyblue", bd=3,
       width=5).place(x=1260, y=605)
